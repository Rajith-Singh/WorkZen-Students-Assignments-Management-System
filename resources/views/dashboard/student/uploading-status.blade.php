...
<html lang="en">
   ...
   <body>
      ...
      <section class="container">
         <h1 class="large text-primary">Status</h1>
         <p class="lead"><i class="fas fa-User"></i> Hi {{ Auth::guard('student')->user()->name }}. Welcome to the WorkZen</p>
         
         <div class="alert alert-success"> The assignment was successfully uploaded. </div>
         ...
         <table>
            ...
            <tr>
                <th> Action </th>
                <td> <a href="/student/viewReuploadingAssignment/{{ Auth::guard('student')->user()->year }}/{{ Auth::guard('student')->user()->semester }}"> Reupload </a> </td>
            </tr>
        </table>
